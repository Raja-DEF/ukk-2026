...
if ($id <= 0) {
    echo "<script>alert('ID aspirasi tidak valid.'); window.location='siswa_histori.php';</script>";
    exit();
}
...
if (!$data) {
    echo "<script>alert('Data aspirasi tidak ditemukan.'); window.location='siswa_histori.php';</script>";
    exit();
}
...
<div class="container mt-4">
    ...
    <a href="siswa_histori.php" class="btn btn-secondary mb-3">Kembali</a>
