...
<div class="container mt-4">
    ...
    <a href="admin_aspirasi_list.php" class="btn btn-primary mt-4">Lihat Semua Aspirasi</a>
    <a href="admin_siswa_add.php" class="btn btn-success mt-4 ms-2">Tambah Data Siswa</a>
    <a href="admin_kategori_add.php" class="btn btn-warning mt-4 ms-2">Tambah Kategori</a>
    ...
    <table class="table table-bordered table-sm">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $row['kelas'] ?></td>
                <td>
                    <a href="admin_dashboard.php?del_nis=<?= $row['nis'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Hapus siswa <?= $row['nis'] ?>?');">Hapus</a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
    ...
    <table class="table table-bordered table-sm">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="admin_dashboard.php?del_cat=<?= $cat['id_kategori'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Hapus kategori ini?');">Hapus</a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
