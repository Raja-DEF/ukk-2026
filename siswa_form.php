...
<nav class="navbar navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="siswa_dashboard.php">Aspirasi Siswa</a>
        <div>
            <a href="siswa_dashboard.php" class="btn btn-light">Dashboard</a>
...
<div class="container mt-4">
    ...
    <a href="siswa_histori.php" class="btn btn-secondary mt-3">Lihat Histori</a>
