...
if ($id <= 0) {
    echo "<script>alert('ID aspirasi tidak valid.'); window.location='aspirasi_list.php';</script>";
    exit();
}
...
if (!$aspirasi) {
    echo "<script>alert('Data aspirasi tidak ditemukan.'); window.location='aspirasi_list.php';</script>";
    exit();
}
...
if (isset($_POST['update'])) {
    ...
    echo "<script>alert('Data updated'); window.location='aspirasi_list.php';</script>";
}
?>
...
<div class="container mt-4">
    <h3>Edit Aspirasi</h3>
    <a href="aspirasi_list.php" class="btn btn-secondary mb-3">Kembali</a>
